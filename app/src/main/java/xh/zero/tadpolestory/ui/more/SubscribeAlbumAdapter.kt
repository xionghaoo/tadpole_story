...
class SubscribeAlbumAdapter(
    ...
    override fun bindItemView(v: View, item: Album?, position: Int) {
        ...
        item.apply {
            ...
            v.findViewById<TextView>(R.id.tv_album_desc).text = recommend_reason
    ...
    private fun bindItem2View(v: View, item: Album?) {
        ...
        v.findViewById<TextView>(R.id.tv_album_desc_2).text = item.recommend_reason
    ...
    override fun itemLayout(): Int = R.layout.list_item_subscribe_albums
