...
import xh.zero.tadpolestory.media.extensions.*
...
class MusicService : MediaBrowserServiceCompat() {
    ...
    private val dataSourceFactory: DefaultDataSourceFactory by lazy {
        DefaultDataSourceFactory(
            /* context= */ this,
            Util.getUserAgent(/* context= */ this, TADPOLE_USER_AGENT), /* listener= */
            null
        )
    }
...
//            ).show()
    ...
    private inner class TadpoleQueueNavigator(
    ...
    private inner class TadpolePlaybackPreparer : MediaSessionConnector.PlaybackPreparer {
...
const val NETWORK_FAILURE = "xh.zero.tadpolestory.media.session.NETWORK_FAILURE"
...
private const val TADPOLE_USER_AGENT = "tadpole.next"
