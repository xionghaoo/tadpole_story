...
const val NOW_PLAYING_CHANNEL_ID = "xh.zero.tadpolestory.media.NOW_PLAYING"
const val NOW_PLAYING_NOTIFICATION_ID = 0xb440 // Arbitrary number used to identify our notification

/**
 * A wrapper class for ExoPlayer's PlayerNotificationManager. It sets up the notification shown to
 * the user during audio playback and provides track metadata, such as track title and icon image.
 */
class StoryNotificationManager(
