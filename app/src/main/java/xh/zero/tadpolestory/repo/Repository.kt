...
class Repository @Inject constructor(
    ...
    fun getAlbumsList(
        ...
        calcDimension: Int,
        categoryId: Int,
        pageSize: Int = Configs.PAGE_SIZE,
        tagName: String? = null
    ) = remoteRequestStrategy {
        apiService.getAlbumsList(page = page, calcDimension = calcDimension, count = pageSize, categoryId = categoryId, tagName = tagName)
    }
    ...
    fun unsubscribe(id: Int) = remoteRequestStrategy {
        tadpoleApiService.unsubscribe(id)
    }

    fun isSubscribe(id: Int) = remoteRequestStrategy {
        tadpoleApiService.isSubscribe(id)
    }
